  ...
  return (
    <footer style={{ backgroundColor: "#17375e" }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p className="text-sm text-slate-300 leading-relaxed text-center max-w-3xl mx-auto mt-4">
          En caso de reclamo ante la entidad aseguradora no resuelto o desestimado, podrá denunciarlo a través de <a href="https://www.argentina.gob.ar/ssn" target="_blank" rel="noreferrer" className="text-accent hover:underline">www.argentina.gob.ar/ssn</a>
        </p>
        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <a
              href="tel:43428721"
              className="bg-white/5 rounded-lg p-3 hover:bg-white/10 transition block text-center"
            >
              <svg
                className="w-4 h-4 text-accent mx-auto mb-1"
                fill="none"
