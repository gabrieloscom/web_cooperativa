...
import BajaFormModal from '../components/BajaFormModal'
import {
...
function Home() {
  const [bajaType, setBajaType] = useState(null)
    ...
    <>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all hover:ring-2 hover:ring-accent p-6 text-center flex flex-col items-center">
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link to="/seguros/hogar" className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all hover:ring-2 hover:ring-accent p-8 flex flex-col items-center text-center gap-4">
            ...
            <Link to="/seguros/automotor" className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all hover:ring-2 hover:ring-accent p-8 flex flex-col items-center text-center gap-4">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4 max-w-2xl mx-auto">
            {empresas.map((item) => (
              <div key={item.title} className="bg-gray-50 rounded-xl p-4 flex flex-col items-center gap-2 hover:shadow-sm transition-all ring-2 ring-accent">
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2 max-w-2xl mx-auto">Gestioná la baja de tu seguro de forma rápida y sencilla</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <button onClick={() => setBajaType('vehiculo')} className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all hover:ring-2 hover:ring-accent p-8 flex flex-col items-center text-center w-full">
              <div className="w-20 h-20 bg-accent/10 rounded-full flex items-center justify-center">
                <DirectionsCarIcon className="text-accent" fontSize="large" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-primary mb-1">Baja de Vehículo o Moto</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Envíanos tu número de patente, fecha de baja y motivo (venta, cambio de aseguradora, sin uso, etc.) para iniciar el trámite.
                </p>
              </div>
              <span className="text-accent font-semibold text-sm hover:text-primary transition-colors">Solicitar baja →</span>
            </button>
            <button onClick={() => setBajaType('otros')} className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all hover:ring-2 hover:ring-accent p-8 flex flex-col items-center text-center w-full">
              <div className="w-20 h-20 bg-accent/10 rounded-full flex items-center justify-center">
                <MuiHomeIcon className="text-accent" fontSize="large" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-primary mb-1">Bajas otros Ramos</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Envíanos tu número de póliza, fecha de baja y nombre completo o DNI para iniciar el trámite correspondiente.
                </p>
              </div>
              <span className="text-accent font-semibold text-sm hover:text-primary transition-colors">Solicitar baja →</span>
            </button>
          </div>
          {bajaType && <BajaFormModal type={bajaType} onClose={() => setBajaType(null)} />}
        </div>
      </section>
      ...
      <section className="py-8 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <a href="/pdf/cocherias.pdf" target="_blank" rel="noreferrer" className="flex flex-col items-center text-center gap-2 bg-gradient-to-br from-primary to-primary-light rounded-xl p-5 shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all hover:ring-2 hover:ring-white/50">
            <div className="w-14 h-14 bg-white/20 rounded-full flex items-center justify-center shrink-0">
              <ChurchIcon className="text-white" fontSize="small" />
            </div>
            <div className="flex flex-col gap-1 items-center">
              ...
              <span className="text-[11px] font-semibold text-white bg-white/20 hover:bg-white/30 px-3 py-1 rounded-full transition-colors">Descargar PDF</span>
            </div>
          </a>
        </div>
      </section>
